...
В данном разделе были проанализированны три алгоритма умножения матриц. Рассчитаны трудоёмкости алгоритмов в лучшем случае (л.с.) и в худшем случае (х.с.).

Стандартный алгоритм: л.с. -- $O(13n^{3})$, х.с. -- $O(13n^{3})$.
